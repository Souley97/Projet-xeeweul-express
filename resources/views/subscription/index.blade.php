            ...
            <section class="py-6 leading-7 text-gray-900 bg-white sm:py-12 md:py-16">
                <div class="box-border px-4 mx-auto border-solid sm:px-6 md:px-6 lg:px-0 max-w-7xl">
                    ...
                    <div id="pricing"
                        ...
                        <div
                            class="relative border-4 border-blue-600 border-solid rounded-lg sm:p-6 z-10 flex flex-col items-center max-w-md p-4 mx-auto my-0 lg:-mr-3 sm:my-0 sm:p-6 md:my-8 md:p-8">
                            <h3
