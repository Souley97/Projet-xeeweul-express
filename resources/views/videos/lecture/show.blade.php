            ...
            <div class="player-wrapper-ratio ratio ratio-21x9">
                <div class="player-container">
                    ...
                    <div class="player-embed overflow-hidden bg-black ratio ratio-21x9">
                        ...
                        <div class="player-embed overflow-hidden bg-black ratio ratio-21x9">
                            <video oncontextmenu="return false;" id="videoPlayer" class="video-js vjs-theme-forest"
                                autoplay controls>
                                <source src="{{ asset('storage/videos/' . $hashVideo->chemin_vers_video) }}"
                                    type="video/mp4">
                                ...
                                <button class="vjs-control vjs-download-button" type="button" title="Télécharger"
                                    style="display: none;">
