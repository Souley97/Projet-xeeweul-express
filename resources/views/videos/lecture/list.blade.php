                    ...
                    <div class="post-body position-relative">
                        <div class="post-main position-relative rounded overflow-hidden">
                            <div class="post-permalink"
                                ...
                                <div
                                    class="post-thumbnail ratio ratio-16x9 rounded overflow-hidden bg-dark">
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/QtToOtjWSbQ?si=fwkIYSZwO-k9NuLa" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    ...
                    <div class="post-body position-relative">
                        <div class="post-main position-relative rounded overflow-hidden">
                            <div class="post-permalink"
                                ...
                                <div
                                    class="post-thumbnail ratio ratio-16x9 rounded overflow-hidden bg-dark">
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/FNUNIbmXWMc?si=1Vl9bwy9dZ8w7V3B" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>                                    <div class="video-paid badge">
                                        <span class="icon icon-lock"></span>
                                    </div>
                                    {{-- <div class="video-hover">
                                        <span
                    ...
                    <div class="post-body position-relative">
                        <div class="post-main position-relative rounded overflow-hidden">
                            <div class="post-permalink"
                                ...
                                <div
                                    class="post-thumbnail ratio ratio-16x9 rounded overflow-hidden bg-dark">
                                    <iframe width="560" height="315" src="https://www.youtube.com/embed/DJRyQsdhguo?si=pKka5gzHLxwz7k08" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                                    <div class="video-paid badge">
                                        <span class="icon icon-lock"></span>
                                    </div>
                                    {{-- <div class="video-hover">
